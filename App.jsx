...
function HubPostar({ queue, setQueue, postLogs, setPostLogs, links, scripts,
                     telegramBot, setTelegramBot, goTo }) {
...
export default function App() {
  ...
  const render = () => {
    switch(tab) {
        ...
        case "Postar":  return <HubPostar queue={st.queue||[]} setQueue={q=>up({queue:q})} postLogs={st.postLogs||[]} setPostLogs={l=>up({postLogs:l})} links={st.links} scripts={st.scripts||[]} telegramBot={st.telegramBot||{token:"",chatId:"",active:false}} setTelegramBot={b=>up({telegramBot:b})} goTo={goTo} />;
